...
export default function IdeaCard() {
  return (
    ...
    <div className='bg-blue-400 w-full h-55 items-center justify-center '>
        <h1 className='text-white text-2xl font-bold italic font-playfair text-center py-10'>"The communities we serve are not waiting to be<br /> saved.
         They are waiting for systems to stop blocking <br />them."
         </h1>
          <div className="text-[#FFDD00] text-[13px] font-bold tracking-[0.2em] uppercase text-center">
              Featured Essay
            </div>
    </div>
    </div>
