...
function IdeasHero() {
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-5xl mx-auto px-5 sm:px-8 lg:px-12 pb-10 sm:pb-0">
        <div className="max-w-2xl">
          <p className="text-harafYellow text-[11px] sm:text-sm font-dm-sans font-bold tracking-[0.2em] uppercase mb-3 sm:mb-4">
            WHERE WE THINK OUT LOUD
          </p>

          <h1 className="text-white text-4xl sm:text-5xl md:text-6xl lg:text-[76px] italic font-playfair font-black leading-[1.08] mb-4 sm:mb-6">
            Ideas That <br />
            Change How <br />
            We See Rural.
          </h1>
