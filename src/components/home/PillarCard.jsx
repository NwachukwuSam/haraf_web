...
const PillarCard = ({ image, tag, title, description, link }) => {
  return (
    <div className="w-full max-w-[400px] bg-[#F7FBFF] rounded-[4px] shadow-[0_2px_10px_rgba(0,0,0,0.05)] flex overflow-hidden">
      {/* Image */}
      <div className="w-[130px] sm:w-[160px] flex-shrink-0 overflow-hidden hover:mouse-pointer">
        <img
          src={image}
          alt={title}
